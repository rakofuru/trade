...
export function loadConfig(cwd = process.cwd()) {
  ...
  return {
    ...
    strategyTrendAdxMin: parseNumber("STRATEGY_TREND_ADX_MIN", env.STRATEGY_TREND_ADX_MIN, 18),
    strategyRangeAdxMax: parseNumber("STRATEGY_RANGE_ADX_MAX", env.STRATEGY_RANGE_ADX_MAX, 17),
    strategyTrendEmaGapBpsMin: parseNumber("STRATEGY_TREND_EMA_GAP_BPS_MIN", env.STRATEGY_TREND_EMA_GAP_BPS_MIN, 6),
    strategyRangeEmaGapBpsMax: parseNumber("STRATEGY_RANGE_EMA_GAP_BPS_MAX", env.STRATEGY_RANGE_EMA_GAP_BPS_MAX, 6),
    ...
    strategyTrendBreakoutConfirmBars: parseInteger("STRATEGY_TREND_BREAKOUT_CONFIRM_BARS", env.STRATEGY_TREND_BREAKOUT_CONFIRM_BARS, 1),
